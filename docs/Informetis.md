...
- [AI racing market](AI_racing_market)
...
data](Activity_Analysis_based_on_Smart_Meter_data)

2019 suggestion: [Activity Recognition and Analysis based on Smart Meter
Data](Activity_Recognition_and_Analysis_based_on_Smart_Meter_Data)

2018 project: [Energy Budget](Energy_Budget)

2017 offer: [Energy with Social
Conscience](Energy_with_Social_Conscience)
