...
- Chris Roberts - [Recipe Curator](Recipe_Curator)
- Rodrigo Queiro – [Dance Practice
  Assistant](Dance_Practice_Assistant)
- Andrew Knights – [Digital Sheet Music
  Viewer](Digital_Sheet_Music_Viewer)
- Alistair Morfey – [Low energy ECC (Elliptic Curve Cryptography)
  library](Low_energy_ECC_(Elliptic_Curve_Cryptography)_library)
- Alistair Morfey – [Application for the new 32-bit XAP6
  Processor](Application_for_the_new_32-bit_XAP6_Processor)