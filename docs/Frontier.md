...
### Confirmed: [Augmented Room Dressing for Zoom](Augmented_Room_Dressing_for_Zoom)
...
### Confirmed: [Robotic Warehouse Design Suite](Robotic_Warehouse_Design_Suite)
...
Preferred? [Opposing Views](Opposing_Views)

[VR AI Ping Pong Trainer](VR_AI_Ping_Pong_Trainer)
...
[Equity Exchange](Equity_Exchange)

## Projects in 2015:

- [Planet Builder](Planet_Builder)
