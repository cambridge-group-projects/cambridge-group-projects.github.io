...
### Bravo: Book Bluffer's Spectacles

Don't you hate it when somebody is displaying a new book, but you haven't got anything clever to say about
...
### Charlie: Reconstructing Sketchpad

Sketchpad was the first interactive
...
### Echo: Extensible Conference Management System
...
Visitors to the Fitzwilliam Museum
...
### Golf: Distributed Game

Take any popular board or card game (preferably
...
### Hotel: Student Comfort System

The student workstation area in the Gates
...
### India: Synthetic Sudoku

A group project coordinator is addicted to
...
### Juliet: 3D Puzzle Experience

A local entrepreneur has designed a new
...
### Lima: Last-Resort PWF Expansion
...
### November: Sampling Synthesiser

Bands that use sampled sounds often want
...
### Oscar: Optical Tomography

We have some hardware to scan the convex
